...
public class Sample_Pom extends Base_Class
...
public static Automation_Logout logout = new Automation_Logout(driver);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		javaScript();
		clickOnElement(imge.getImge2());
		driver.switchTo().frame(0);
		//WebElement add3 = driver.findElement(By.xpath("//p[@id='add_to_cart']//descendant::span"));
		clickOnElement(acart.getCart3());
		driver.switchTo().defaultContent();
		clickOnElement(cbtn1.getBtn1_3());
		clickOnElement(cbtn2.getBtn2());
